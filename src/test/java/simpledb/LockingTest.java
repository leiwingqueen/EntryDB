...
import simpledb.transaction.SimpleLockManager;
...
public class LockingTest extends TestUtil.CreateHeapFile {
    ...
    @Test
    public void acquireSimpleTest() {
        SimpleLockManager lockManager = (SimpleLockManager) Database.getBufferPool().getLockManager();
        TransactionId t1 = new TransactionId();
        TransactionId t2 = new TransactionId();
        PageId pageId = new HeapPageId(1, 1);
        boolean r1 = lockManager.tryAcquire(LockManager.LockMode.X_LOCK, t1, pageId);
        boolean r2 = lockManager.tryAcquire(LockManager.LockMode.S_LOCK, t2, pageId);
