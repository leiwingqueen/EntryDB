...
import com.entry.db.optimizer.JoinOptimizer;
import com.entry.db.optimizer.LogicalJoinNode;
import com.entry.db.optimizer.TableStats;
import com.entry.db.storage.BufferPool;
import com.entry.db.storage.HeapFile;
import com.entry.db.storage.HeapFileEncoder;
...
public class JoinOptimizerTest extends SimpleDbTestBase {
    ...
    public void enumerateSubsetsTest() {
        ...
        Set<Set<Integer>> subsets = JoinOptimizer.enumerateSubsets2(list, 2);
