...
import com.entry.db.index.BTreeLeafPage;
import com.entry.db.index.BTreePageId;
...
import com.entry.db.TestUtil.SkeletonFile;
...
public class BTreeLeafPageTest extends SimpleDbTestBase {
	...
	@Test public void testIterator() throws Exception {
		...
		tuples.sort(new BTreeFileEncoder.TupleComparator(0));
	...
	@Test public void addTuple() throws Exception {
		...
		tuples.sort(new BTreeFileEncoder.TupleComparator(1));
