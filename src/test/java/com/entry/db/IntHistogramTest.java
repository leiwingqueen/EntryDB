...
import com.entry.db.optimizer.IntHistogram;
...
public class IntHistogramTest {
	...
	@Test public void negativeRangeTest() {
		...
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.EQUALS, -33) < 0.3);
		...
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.EQUALS, -33) > 0.001);
	}
	...
	@Test public void opEqualsTest() {
		...
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.EQUALS, 3) > 0.8);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.EQUALS, 8) < 0.001);
	}
	...
	@Test public void opGreaterThanTest() {
		...
		// Be conservative in case of alternate implementations
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.GREATER_THAN, -1) > 0.999);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.GREATER_THAN, 2) > 0.6);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.GREATER_THAN, 4) < 0.4);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.GREATER_THAN, 12) < 0.001);
	}
	...
	@Test public void opLessThanTest() {
		...
		// Be conservative in case of alternate implementations
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.LESS_THAN, -1) < 0.001);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.LESS_THAN, 2) < 0.4);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.LESS_THAN, 4) > 0.6);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.LESS_THAN, 12) > 0.999);
	}
	...
	@Test public void opGreaterThanOrEqualsTest() {
		...
		// Be conservative in case of alternate implementations
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.GREATER_THAN_OR_EQ, -1) > 0.999);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.GREATER_THAN_OR_EQ, 2) > 0.6);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.GREATER_THAN_OR_EQ, 3) > 0.45);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.GREATER_THAN_OR_EQ, 4) < 0.5);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.GREATER_THAN_OR_EQ, 12) < 0.001);
	}
	...
	@Test public void opLessThanOrEqualsTest() {
		...
		// Be conservative in case of alternate implementations
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.LESS_THAN_OR_EQ, -1) < 0.001);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.LESS_THAN_OR_EQ, 2) < 0.4);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.LESS_THAN_OR_EQ, 3) > 0.45);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.LESS_THAN_OR_EQ, 4) > 0.6);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.LESS_THAN_OR_EQ, 12) > 0.999);
	}
	...
	@Test public void opNotEqualsTest() {
		...
		// Be conservative in case of alternate implementations
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.NOT_EQUALS, 3) < 0.001);
		Assert.assertTrue(h.estimateSelectivity(Predicate.Op.NOT_EQUALS, 8) > 0.01);
	}
}
