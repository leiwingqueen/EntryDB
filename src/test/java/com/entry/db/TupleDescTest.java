...
public class TupleDescTest extends SimpleDbTestBase {
    ...
    @Test public void combine() {
        ...
        Assert.assertEquals(3 * Type.INT_TYPE.getLen(), td3.getSize());
        for (int i = 0; i < 3; ++i)
            Assert.assertEquals(Type.INT_TYPE, td3.getFieldType(i));
    ...
    @Test public void getType() {
        ...
        for (int len: lengths) {
            ...
            for (int i = 0; i < len; ++i)
                Assert.assertEquals(Type.INT_TYPE, td.getFieldType(i));
        }
    }
