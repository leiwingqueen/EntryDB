...
public class BTreeTest extends SimpleDbTestBase {
    ...
    public void testBigFile() throws Exception {
        ...
        log.info("Creating large random B+ tree...");
        ...
        log.info("Inserting and deleting tuples...");
